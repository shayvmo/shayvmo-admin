        ...
        <el-dialog class="app-attachment-dialog"
            ...
            <template v-else>
                ...
                <div flex="box:first" style="border: 1px solid #e3e3e3;margin-bottom: 10px;min-height: 300px">
                    <div style="border-right: 1px solid #e3e3e3" class="left-side">
                    ...
                    <div v-loading="loading" flex="dir:top"  class="right-side">
...
<script>
    Vue.component('app-attachment', {
        ...
        methods: {
            ...
            loadList(params) {
                var json = '{"code":0,"data":{"list":[{"id":"1","storage_id":"1","attachment_group_id":"0","user_id":"0","mall_id":"1","mch_id":"0","name":"点心.jpg","size":"37143","url":"http://weigou.test/web/uploads/mall1/20210428/5550c8915549a09809cb43d4d7e6e769.jpg","thumb_url":"http://weigou.test/web/uploads/thumbs/mall1/20210428/5550c8915549a09809cb43d4d7e6e769.jpg","type":"1","created_at":"2021-04-28 11:45:28","updated_at":"2021-04-28 11:45:28","deleted_at":"0000-00-00 00:00:00","is_delete":"0","is_recycle":"0"}],"pagination":{"defaultPageSize":10,"pageSize":20,"total_count":1,"page_count":1,"current_page":1,"pageParam":"page","pageSizeParam":"per-page","forcePageParam":true,"route":null,"params":null,"urlManager":null,"validatePage":true,"totalCount":1,"pageSizeLimit":[1,50]}}}';
                this.noMore = false;
