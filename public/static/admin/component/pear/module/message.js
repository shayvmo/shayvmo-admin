    ...
    function createHtml(option) {
        ...
        $.each(option.data, function(i, item) {
            ...
            $.each(item.children, function(i, note) {
                noticeContent += '<div class="pear-notice-item" style="cursor: pointer" notice-form="' + note.form + '" notice-context="' + note.context +
        ...
        notice += '</a><div class="layui-nav-child layui-tab pear-notice" style="margin-top: 0px;;left: -200px;">';
